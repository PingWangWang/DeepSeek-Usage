...
[![Version](https://img.shields.io/badge/version-1.38.9-blue)]()
...
- **区间选择与自动刷新**：顶部「起 / 止」双下拉框切换统计区间（默认当年 1 月 → 当前月），支持 30s~1h 的可选自动刷新
...
- **自动主题适配**：跟随 DeepSeek 页面明/暗模式自动切换图表配色；也可用头部「主题」按钮强制浅色/深色
